...
try(
    {
      ...
      #   - An archive of the data up to 2023-12-13 produced by the API call below was created on 2023-12-19 called "data/phe_coronavirus_dashboard_api_data/cases_ltla.csv" and "data/phe_coronavirus_dashboard_api_data/cases_nation.csv"
      #   - In the event of the original API calls no longer working, replace with the following until we can obtain data from the new dashboard API:
        
      # cases_ltla <- read_csv("data/phe_coronavirus_dashboard_api_data/cases_ltla.csv")
      # cases_nation <- read_csv("data/phe_coronavirus_dashboard_api_data/cases_nation.csv")
...
try(
    {
      ...
      #   - The original PHE coronavirus dashboard at https://coronavirus.data.gov.uk is being replaced by https://ukhsa-dashboard.data.gov.uk/topics/covid-19
      #   - Final data update on the original coronavirus dashboard took place on 2023-12-14
      #   - An archive of the data up to 2023-12-09 produced by the API call below was created on 2023-12-19 called "data/phe_coronavirus_dashboard_api_data/msoa_cases.csv"
      #   - In the event of the original API call no longer working, replace with the following until we can obtain data from the new dashboard API:
        
      # msoa_cases <- read_csv("data/phe_coronavirus_dashboard_api_data/msoa_cases.csv") %>%
...
try(
    {
      ...
      #   - The original PHE coronavirus dashboard at https://coronavirus.data.gov.uk is being replaced by https://ukhsa-dashboard.data.gov.uk/topics/covid-19
      #   - Final data update on the original coronavirus dashboard took place on 2023-12-14
      #   - An archive of the data up to 2023-12-09 produced by the API call below was created on 2023-12-19 called "data/phe_coronavirus_dashboard_api_data/age_specific_cases.csv"
      #   - In the event of the original API call no longer working, replace with the following until we can obtain data from the new dashboard API:
        
      # age_specific_cases <- read_csv("data/phe_coronavirus_dashboard_api_data/age_specific_cases.csv") %>%    
...
try(
    {
      ...
      #   - The original PHE coronavirus dashboard at https://coronavirus.data.gov.uk is being replaced by https://ukhsa-dashboard.data.gov.uk/topics/covid-19
      #   - Final data update on the original coronavirus dashboard took place on 2023-12-14
      #   - An archive of the data up to 2023-12-04 produced by the API call below was created on 2023-12-19 called "data/phe_coronavirus_dashboard_api_data/positivity_rate.csv"
      #   - In the event of the original API call no longer working, comment out the api_response <- GET(... and if (api_response$status_code == 200) {... blocks and replace with the following until we can obtain data from the new dashboard API:
        
      # positivity_rate <- read_csv("data/phe_coronavirus_dashboard_api_data/positivity_rate.csv")
...
try(
    {
      ...
      #   - The original PHE coronavirus dashboard at https://coronavirus.data.gov.uk is being replaced by https://ukhsa-dashboard.data.gov.uk/topics/covid-19
      #   - Final data update on the original coronavirus dashboard took place on 2023-12-14
      #   - An archive of the data up to 2023-12-08 produced by the API call below was created on 2023-12-19 called "data/phe_coronavirus_dashboard_api_data/hospital_cases.csv"
      #   - In the event of the original API call no longer working, replace with the following until we can obtain data from the new dashboard API:
        
      # hospital_cases <- read_csv("data/phe_coronavirus_dashboard_api_data/hospital_cases.csv") %>%
