...
try(
    {
      ...
      msoa_cases <- left_join(msoa, msoa_cases, by = "msoa11cd") %>% 
      ...
      msoa_latest_date <- format(msoa_latest_date, '%d %B')
    },
    silent = TRUE
)
      ...
      if (api_response$status_code == 200) {
        ...
        alt_positivity_rate <- str_c(
          slice_max(positivity_rate,
                    ...
                    '% of tests positive (7 day average) as at ', 
