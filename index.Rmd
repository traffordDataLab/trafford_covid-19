...
div(class = "subtitle",
        div(class = "title", "Daily versus total confirmed cases"),
         paste("14-day moving average on log scale, to", format(max(trajectory$date), '%d %B %Y')))
...
trajectory %>% 
  ...
  labs(x = "Total confirmed cases", y = "Daily confirmed cases", title = NULL, subtitle = NULL, caption = NULL) +
  theme_minimal(base_size = 20, base_family = "Lato") +
  theme(plot.margin = margin(0.5, 0.5, 0.5, 0.5, "cm"),
        panel.grid.major.x = element_blank(),
        panel.grid.minor = element_blank(),
