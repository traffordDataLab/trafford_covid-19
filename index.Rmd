...
breaks <- classIntervals(msoa_cases[msoa_cases$rate > 0, ]$rate, n = 5, style = "jenks")$brks
...
# create map
leaflet(data = filter(msoa_cases, rate != 0), width = "100%") %>%
